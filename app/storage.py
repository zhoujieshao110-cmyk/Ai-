...
CONFIG_SECTIONS = [
        ...
        "fields": [
            {
                ...
                "secret": False,
                "kind": "select",
                "help": "auto 会沿用原来的优先级；chatgpt_handoff 会打开 ChatGPT 并等待你保存图片到目标路径。",
                "options": [
    ...
    },
    {
        "key": "apiyi_image",
        "title": "OpenAI 兼容文生图",
        "description": "用于接入 OpenAI 兼容的图片生成接口，可替代方舟场景图与封面图。",
        "validator": "apiyi_image",
        "fields": [
            {
                "key": "APIYI_API_KEY",
                "label": "OpenAI 兼容 API 密钥",
                "required": True,
                "secret": True,
                "kind": "secret",
                "help": "填写你的图片生成服务密钥，支持 OpenAI 兼容网关或中转。",
            },
            {
                "key": "APIYI_BASE_URL",
